...
class KeywordsExtractor:
    ...
    """
    Facilitate keyword extraction using a structured-output model.
    ...
    def __init__(self, model: BaseChatModel) -> None:
        """
        Initialize the instance with a structured-output model based on the provided base chat model.
    ...
    def __call__(self, state: KeywordsState, runtime: Runtime[MindMapContext]) -> Keywords:
        ...
        if not state.input_text:
            runtime.stream_writer("No input text for keyword extraction.")
